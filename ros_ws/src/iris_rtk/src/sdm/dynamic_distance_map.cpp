...
DynamicDistanceMap::DynamicDistanceMap(double resolution, uint32_t patch_size, bool is3d)
...
DynamicDistanceMap::DynamicDistanceMap(const DynamicDistanceMap& other)
    : DistanceMap(other)
{
...
DynamicDistanceMap::~DynamicDistanceMap()
{}


double DynamicDistanceMap::distance(const Vector3d& coordinates, Vector3d* gradient) const
{
...
double DynamicDistanceMap::distance(const Vector3ui& coordinates) const
{
...
void DynamicDistanceMap::setMaxDistance(double distance)
{
    max_sqdist_  = std::ceil( distance * scale );
    max_sqdist_ *= max_sqdist_;
}

double DynamicDistanceMap::maxDistance() const
{
    return std::sqrt((double)(max_sqdist_)) * resolution;
}

uint32_t DynamicDistanceMap::update()
{
    uint32_t prio = 0;
...
void DynamicDistanceMap::writeParameters(std::ofstream& stream) const
{
    stream.write((char*)&max_sqdist_, sizeof(max_sqdist_));
}

void DynamicDistanceMap::readParameters(std::ifstream& stream)
{
...
//==================================================================================================
//
void DynamicDistanceMap::addObstacle(const Vector3ui& location)
{
...
void DynamicDistanceMap::removeObstacle(const Vector3ui& location)
{
    distance_t* cell = (distance_t*) get(location);
    if (cell == nullptr) return;
...
void DynamicDistanceMap::raise(const Vector3ui& location, distance_t& current)
{
    Vector3ui newloc;
...
void DynamicDistanceMap::lower(const Vector3ui& location, distance_t& current)
{
    // motion direction
