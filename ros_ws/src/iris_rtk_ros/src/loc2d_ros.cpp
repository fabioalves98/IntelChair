...
#include "rtk/ros/loc2d_ros.h"

rtk::Loc2DROS::Loc2DROS()
    : nh_(), pnh_("~")
{
...
void rtk::Loc2DROS::onLaserScan(const sensor_msgs::LaserScanConstPtr& laser_scan)
{
    ...
    if (update){
        ...
        rtk::geom::Pose2D pose = loc2d_.getPose();
...
void rtk::Loc2DROS::InitLoc2DFromOccupancyGridMsg(const nav_msgs::OccupancyGrid& msg)
{
    ...
    rtk::slam::Loc2D::Options options;
...
bool rtk::Loc2DROS::initLaser(const sensor_msgs::LaserScanConstPtr& laser_scan)
{
