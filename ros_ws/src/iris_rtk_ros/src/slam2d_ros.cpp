    ...
    : nh_(), pnh_("~")
{
    ...
    rtk::slam::Slam2D::Options options;
    ...
    pnh_.param("map_publish_period", tmp, 10.0 );
    map_publish_period_ = ros::WallDuration(tmp);

    slam2d_ = new rtk::slam::Slam2D(options);
...
void Slam2DROS::onLaserScan(const sensor_msgs::LaserScanConstPtr& laser_scan)
{
    int laser_index = -1;
...
bool Slam2DROS::initLaser(const sensor_msgs::LaserScanConstPtr& laser_scan)
{
...
bool Slam2DROS::OccupancyMsgFromOccupancyMap(nav_msgs::OccupancyGrid& msg)
{
...
bool Slam2DROS::DistanceMsgFromOccupancyMap(nav_msgs::OccupancyGrid& msg)
{
...
bool Slam2DROS::onGetMap(nav_msgs::GetMap::Request &req, nav_msgs::GetMap::Response &res)
{
